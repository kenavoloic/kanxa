<main id="utilisateur">
	...
	<dd class="primaire"><span><?= ucfirst($tableau['cloture']->getNomDateMoisAnnee()) ?></span></dd>
	...
	<dd class="primaire"><span><?= ucfirst($tableau['debut']->getNomDateMoisAnnee()) ?></span></dd>
    ...
    <dl id="finales">
	<dt>Finales</dt>
	<dd class="primaire"><span><?= $tableau['finales']->getNomDateMoisAnnee() ?></span></dd>
